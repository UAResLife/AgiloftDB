...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_EmployeeHist] ([NetID], [PreferredFirstName], [PreferredLastName], [Department], [Unit], [PrimaryJobPosition], [Email], [OfficePhone], [MobilePhone], [EmployeeStatus], [TerminationDate], [SupervisorNetID], [DateChanged], [DateMoved])
        SELECT [NetID],
               [PreferredFirstName],
               [PreferredLastName],
               [Department],
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_EmployeeTemp] ([NetID], [PreferredFirstName], [PreferredLastName], [Department], [Unit], [PrimaryJobPosition], [Email], [OfficePhone], [MobilePhone], [EmployeeStatus], [TerminationDate], [SupervisorNetID])
        SELECT   [NetID],
                 [PreferredFirstName],
                 [PreferredLastName],
                 [Department],
