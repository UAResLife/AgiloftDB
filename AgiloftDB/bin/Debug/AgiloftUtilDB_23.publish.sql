...
GO
/*
The column [dbo].[Employee].[MobilePhone] is being dropped, data loss could occur.
*/
...
GO
/*
The column [dbo].[EmployeeHist].[MobilePhone] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[EmployeeHist])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
/*
The column [dbo].[EmployeeTemp].[MobilePhone] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[EmployeeTemp])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT
