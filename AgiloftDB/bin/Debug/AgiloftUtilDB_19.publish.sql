...
GO
PRINT N'Dropping [dbo].[PK_FiscalPeriodHist_ID]...';


GO
ALTER TABLE [dbo].[FiscalPeriodHist] DROP CONSTRAINT [PK_FiscalPeriodHist_ID];


GO
PRINT N'Dropping [dbo].[PK_FiscalQuarterHist_ID]...';


GO
ALTER TABLE [dbo].[FiscalQuarterHist] DROP CONSTRAINT [PK_FiscalQuarterHist_ID];
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Employee])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Employee] ([NetID], [PreferredFirstName], [PreferredLastName], [Department], [Unit], [PrimaryJobPosition], [Email], [OfficePhone], [MobilePhone], [EmployeeStatus], [TerminationDate], [SupervisorNetID], [DateChanged])
        SELECT   [NetID],
                 [PreferredFirstName],
                 [PreferredLastName],
                 [Department],
