...
IF EXISTS (select top 1 1 from [dbo].[FiscalPeriod])
...
IF EXISTS (select top 1 1 from [dbo].[SubAccount])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT
...
GO
ALTER TABLE [dbo].[FiscalPeriod] ALTER COLUMN [FiscalYear] INT NOT NULL;

ALTER TABLE [dbo].[FiscalPeriod] ALTER COLUMN [QuarterID] INT NOT NULL;
...
GO
ALTER TABLE [dbo].[SubAccount] ALTER COLUMN [AccountNumber] INT NOT NULL;
...
GO
PRINT N'Refreshing [dbo].[ImportFiscalPeriod]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ImportFiscalPeriod]';


GO
PRINT N'Refreshing [dbo].[ImportSubAccount]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[ImportSubAccount]';
